        ...
        <Form className="loginform_container" onSubmit={handleSubmit}>
          ...
          <div
            className={`email  ${
              errors.email && touched.email
                ? "loginmargin_content"
                : "logincontainer_field"
            }`}
          >
            <Form.Label className="field_label loginform-label">
              Email
            </Form.Label>
            <Form.Control
              type="email"
              placeholder="Enter email"
              className="logininput_box"
              name="email"
            ...
            />
            {errors.email && touched.email ? (
              <p className="loginwarning_errors">{errors.email}</p>
            ) : null}
          </div>
          <div
            className={`password  ${
              errors.password && touched.password
                ? "loginmargin_content_password"
                : "logincontainer_field_password"
            }`}
          >
            <Form.Label className="field_label loginform-label">
              Password
            ...
            />
            {errors.password && touched.password ? (
              <p className="loginwarning_errors">{errors.password}</p>
            ) : null}
          </div>
          <div
          ...
          >
            <Form.Group className="" id="formGridCheckbox">
              <Form.Check
                ...
                name="checkbox"
                className="terms_condtions_label"
                onChange={handleChange}
                onBlur={handleBlur}
                checked={values.checkbox}
              />
              {errors.checkbox && touched.checkbox ? (
                <p className="loginwarning_errors login_error">
                  {errors.checkbox}
                </p>
              ) : null}
            </Form.Group>
          ...
          <div className="signup_para__container">
            <Link to="/signup" className="para_singup">
              Do You have an account?<span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
